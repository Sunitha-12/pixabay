  ...
  let view=(e)=>{
    ...
    return(
        ...
        <i class="fa-solid fa-magnifying-glass" style={{position:"relative",left:"1000px"}}></i>
         <input type="text" onChange={view} placeholder="Search for all images on Pixabay" style={{width:"602px",height:"15px",borderRadius:"30px",margin:"-15px 0px 15px 380px",padding:"25px"}}/> <br />
         {api.product.map(x=>{
            return(
                <>
